...
archives and execution on both declared OS targets. See [Apple's arm64 signing
requirement](https://support.apple.com/guide/security/secebb113be1/web).
Final verification allows
