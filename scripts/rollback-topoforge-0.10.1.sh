...
rollback_dir="${TOPOFORGE_ROLLBACK_DIR:-../TopoForge-0.10.0}"
...
cat <<EOF
TopoForge 0.10.0 source rollback worktree created at $rollback_dir.
The 0.10.1 checkout and retained DEMs, caches, outputs, backups, and Web workspaces were not changed.
EOF
